...
class Pendidikan_c extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('member/pendidikan/home', $data);
	...
	{	
		...
		$this->load->view('parts/header', $data);
		$this->load->view('member/pendidikan/daftar_anggota', $data);
		$this->load->view('parts/footer', $data);
	}
...
/* End of file pendidikan_c.php */
/* Location: ./application/controllers/pendidikan_c.php */ ?>