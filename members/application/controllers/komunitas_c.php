...
class Komunitas_c extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('member/komunitas/home', $data);
	...
	{	
		...
		$this->load->view('parts/header', $data);
		$this->load->view('member/komunitas/daftar_anggota', $data);
		$this->load->view('parts/footer', $data);
	}
...
/* End of file komunitas_c.php */
/* Location: ./application/controllers/komunitas_c.php */ ?>