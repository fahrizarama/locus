...
class Personal_c extends CI_Controller {
	...
	{	
		...
		$data['session_id_member'] = $this->session->userdata('id_member');
		$data['members'] = $this->member_m->getAllKategori()->result();

		$this->load->view('parts/header', $data);
		$this->load->view('member/personal/home', $data);
		$this->load->view('parts/footer', $data);
	}

	public function delete($id)
	{
       $this->db->delete('tb_artikel', array('id' => $id));
...
/* End of file personal_c.php */
/* Location: ./application/controllers/personal_c.php */ ?>