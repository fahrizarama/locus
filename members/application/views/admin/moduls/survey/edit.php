...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditgaleri" action="<?= base_url('C_survey/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_survey" value="<?= $data->id_survey?>">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Edit Survey</h3>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="deskripsi_survey" id="edit_input_deskripsi" placeholder="Deskripsi Survey"><?= $data->deskripsi_survey?></textarea>
                    </div>
                </div>
            </div>
