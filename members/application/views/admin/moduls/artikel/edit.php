...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditPengalaman" action="<?= base_url('C_artikel/edit_produk') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="id_member"  name="id_member"  class="form-control">
                            <option selected value="<?= $data->id_member?>" style="display: none;"><?= $data->nama_member?></option>
                        <?php
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="deskripsi_artikel" id="edit_input_deskripsi" placeholder="Deskripsi Artikel"><?= $data->deskripsi_artikel ?></textarea>
                    </div>
