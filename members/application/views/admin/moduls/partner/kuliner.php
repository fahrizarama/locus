    ...
    <div id="Kuliner" class="city">
      <div style="padding: 20px 0 25px 0;">
            <a href="#tambahprodukkuliner" role="button" class="btn btn-primary" data-toggle="modal">Tambah Partner Kuliner</a>
        </div>

        <div id="tambahprodukkuliner" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddKuliner" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <input type="hidden" class="form-control" name="jenis_partner" value="1">
