...
<div class="container">
  ...
  <div id="login-form">
      <form action="<?= base_url('login/insert_registrasi_pendidikan') ?>" method="POST" enctype="multipart/form-data">
      <div class="col-md-12">
            <br><br>
        <div class="wow">
          ...
          <div class="te">
            <div class="form-group">
              <h2 class="heading_a uk-margin-medium-bottom uk-text-center">Registrasi Akun Membership Lembaga Pendidikan</h2>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6" style="margin-right: 10px; float: left;">
                <div class="form-group">
                    ...
                    <span class="has-false"><?= form_error('anggota_id3')?></span>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <input type="file" class="form-control title-form" name="foto_kta2" required>
