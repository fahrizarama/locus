      ...
      <div class="col-md-12">
        ...
        <div class="wow">
          ...
          <div class="te">
            ...
            <div class="row">
              <div class="col-lg-6" style="margin-right: 10px; float: left;">
                <div class="form-group <?= form_error('no_anggota') ? 'has-top' : null ?>">
                    <label class="title-form">Instansi/Perusahaan*</label>
                    <select name="anggota_id2" class="form-control">
                      <option disabled selected style="display: none;">-- Pilih Instansi/Perusahaan --</option>
                      <option value="0" <?= set_value('anggota_id2') == '0' ? "selected" : null?>>Tidak Ada</option>
                      <?php foreach ($instansi->result() as $row) :?>
                      <option value="<?= $row->id_member ?>" <?= set_value('anggota_id2') == $row->id_member ? "selected" : null?> ><?= $row->nama_member ?></option>
                      <?php endforeach; ?>
                    </select>
                </div>
              </div>

              <div class="row <?= form_error('no_anggota') ? 'has-top' : null ?>">
                <div class="form-group <?= form_error('foto_kta1') ? 'has-error' : null ?>">
                  <label class="title-form">Foto KTA Instansi/Perusahaan*</label>
                <input type="file" class="form-control title-form" name="foto_kta1">
                <span class="has-not"><?= form_error('foto_kta1')?></span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-6" style="margin-right: 10px; float: left;">
                <div class="form-group">
                    <label class="title-form">Lembaga Pendidikan*</label>
                    <select name="anggota_id3" class="form-control">
                      <option disabled selected style="display: none;">-- Pilih Lembaga Pendidikan --</option>
                      <option value="0" <?= set_value('anggota_id3') == '0' ? "selected" : null?>>Tidak Ada</option>                  
                      <?php foreach ($pendidikan->result() as $key) :?>
                      <option value="<?= $key->id_member ?>" <?= set_value('anggota_id3') == $key->id_member ? "selected" : null?> ><?= $key->nama_member ?></option>
                      <?php endforeach; ?>
                    </select>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group <?= form_error('foto_kta2') ? 'has-error' : null ?>">
                  <label class="title-form">Foto KTA Lembaga Pendidikan*</label>
                <input type="file" class="form-control title-form" name="foto_kta2">
                <span class="has-not"><?= form_error('foto_kta2')?></span>
                </div>
              </div>
            </div>

<!--             <div class="form-group">
              <label class="title-form">Pilih Kategori Membership yang diikuti*</label>
                  <select name="id_kategori" class="form-control" id="jenis_kategori">
                    <option disabled selected style="display: none;">-- Pilih Kategori Membership --</option>
                    <?php foreach ($result->result() as $member) :
                      if ($member->kategori_member != 'Personal') {?>
                      <option value="<?= $member->id_kategori ?>" id="<?= $member->id_kategori ?>" ><?= $member->kategori_member?></option>
                      <?php }
                    ?>
                    <?php endforeach; ?>
                  </select>
            ...
            <!-- <div class="form-group">
                ...
                <input type="text" name="profesi_member" class="form-control" placeholder="Profesi" maxlength="50" required="required"/>
                </div>
