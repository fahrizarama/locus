                ...
                <div class="row latest_blog_inner">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="l_blog_item">
                            ...
                            <a class="date" href="<?php echo site_url('Event_c/detail/'.$result->id_event) ?>"><i class="lnr lnr-calendar-full" style="padding-right: 7px;"></i><?php echo $result->tanggal_event ?> &nbsp;&nbsp;|  <i class="lnr lnr-clock" style="padding-right: 7px; padding-left: 7px;"></i><?php echo $result->jam_event ?><h4><?php echo $result->judul_event ?></h4></a>
                        </div>
                    </div>
                 <?php } } ?>              
                </div>
