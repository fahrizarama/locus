                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                   <div class="blog_info text-right">
                                        ...
                                        $find_count = mysqli_query($conn, "SELECT artikel_dilihat FROM tb_artikel WHERE id_artikel = ".$result->id_artikel);

                                        while ($row = mysqli_fetch_assoc($find_count)) {
                                            $current_count = $row['artikel_dilihat'];
                                            $new_count = $current_count + 1;
                                            $update_count = mysqli_query($conn,"UPDATE tb_artikel SET artikel_dilihat = ".$new_count."  WHERE id_artikel = ".$result->id_artikel);
                                        }
                                         ?>
                                ...
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="desc">
                                            ...
                                            <p class="date"><?php echo $komentar->tanggal_komentar ?></p>
                                            <p class="comment">
