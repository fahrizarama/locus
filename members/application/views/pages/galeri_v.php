                        ...
                        <?php foreach ($galeri->result() as $result) : ?>
                          <div class="col-md-4">
                            ...
                            <div class="l_blog_item">
                                <a class="date" href=""><i class="lnr lnr-calendar-full" style="padding-right: 7px;"></i><?php echo substr($result->tanggal_foto, 0, 20)?><h4><?php echo substr($result->deskripsi_foto, 0, 50)?></h4></a>
                            </div>
                            </div>
                          </div>
                        <?php endforeach; ?>
