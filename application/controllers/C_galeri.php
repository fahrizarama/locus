...
class C_galeri extends CI_Controller
{
    ...
    {   
        ...
        $dataInsert['deskripsi_foto'] = $deskripsi_foto;
        $dataInsert['tanggal_foto'] = $tanggal_foto;
    ...
    public function edit_produk()
    {
        ...
        $deskripsi_foto = getPost('deskripsi_foto');
        $tanggal_foto = getPost('tanggal_foto');

        $updateData['deskripsi_foto'] = $deskripsi_foto;
        $updateData['tanggal_foto'] = $tanggal_foto;
