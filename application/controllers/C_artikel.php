...
class C_artikel extends CI_Controller
{
    ...
    public function add_produk()
    {
        ...
        $upload->setConfig(array(
            'upload_path' => realpath('members/assets/img'),
    ...
    public function publish_artikel()
    {
        ...
        $updateData['status_artikel'] = '1';

        if ($this->artikel->update($id, $updateData)) {
            return JSONResponseDefault('OK', 'Artikel berhasil dipublish');
        } else {
            return JSONResponseDefault('FAILED', 'Gagal mempublish artikel');
        }
    }
    ...
    private function edit_img_remover($upload, $row, $index = array())
    {
        ...
        $this->remover($upload, $deletedData, 'members/assets/img');
