                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="<?php echo site_url('artikel_c/detail/'.$result->artikel_id) ?>"><h2><?php echo $result->judul_artikel ?></h2></a>
                                            <p><?php echo substr($result->deskripsi_artikel, 0, 100). " ..... " ?></p>
                                            <a href="<?php echo site_url('artikel_c/detail/'.$result->artikel_id) ?>" class="white_bg_btn">Tampilkan Lebih</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
                        ...
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="<?php echo base_url('members/assets/'); ?>img/<?php echo $data->foto_artikel ?>" width="200px" alt="post">
