                ...
                <div class="container">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="<?php echo site_url('Produk_c') ?>">Daftar Produk</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row team_inner">
                    <?php foreach ($produk as $result) { ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="team_item">
                                <div class="team_img">
                                    <img class="rounded-circle" src="<?php echo base_url('assets/foto_produk/'); ?><?php echo $result->foto ?>" alt="">
                                    <div class="hover">
                                    </div>
                                </div>
                                <div class="team_name">
                                    <a href="<?php echo site_url('Produk_c/detail/' . $result->id_produk) ?>">
                                        <h4><?php echo $result->nama_produk ?></h4>
                                    </a>
                                    <h5>Rp. <?= number_format($result->harga_publish, 0, ".", ".") ?></h5>
