...
<div class="row">
    ...
    <div class="tab">
        <?php foreach($jenis_partner as $jenis) : ?>
            <a href=<?= base_url ('C_partner/index/'.$jenis->id_jenis_partner) ?> ><?php echo $jenis->nama_jenis_partner ?></a>
        <?php endforeach; ?>
    </div>

    <?php $this->load->view('admin/moduls/partner/partner_v') ?>
...
<script>
    function delete_produk(id) {
        ...
        if (confirmation) {
            $.ajax({
                url: '<?= base_url('C_partner/hapus_produk') ?>',
                method: 'POST',
                dataType: 'json',
                data: {
                    id: id
    ...
    function edit_produk(id) {
        $.ajax({
            url: '<?= base_url('C_partner/modal_edit_produk') ?>',
            method: 'POST',
            dataType: 'json',
            data: {
                id: id
