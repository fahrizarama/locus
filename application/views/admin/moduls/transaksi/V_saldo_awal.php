...
?>
<?php $title = "<i class='far fa-handshake'></i>&nbsp;Set Saldo Awal"; ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container">
            <form class="form-horizontal" role="form" id="formTransaksi" action="<?= base_url('C_transaksi/add_transaksi_saldo_awal') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label>Akun :</label>
                            <select id="id_akun" name="id_akun"  class="form-control" required>
                                ...
                                <?php if(count($akun) > 0 ) { ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php } else { ?>
                                    <option value="" disabled selected>Akun Tidak Tersedia, Silahkan Tambahkan Terlebih Dahulu</option>
                                <?php } ?>
                            </select>
                        </div>
