...
?>
<?php $title = "<i class='far fa-handshake'></i>&nbsp;Transaksi Pengeluaran Tunai"; ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container">
            <form class="form-horizontal" role="form" id="formTransaksi" action="<?= base_url('C_transaksi/add_transaksi_pengeluaran_tunai') ?>" method="POST" enctype="multipart/form-data">
