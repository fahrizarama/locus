...
?>
<?php $title = "<i class='far fa-handshake'></i>&nbsp;Transaksi Pengeluaran Sebagai Hutang"; ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container">
            <form class="form-horizontal" role="form" id="formTransaksi" action="<?= base_url('C_transaksi/add_transaksi_pengeluaran_hutang') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="id_kontak"  name="id_kontak"  class="form-control" required>
                                <option disabled selected style="display: none;" value="">Pilih Kontak</option>
                                <?php foreach ($kontak as $row):?>
                                    <option value="<?= $row->id?>"><?= $row->nama?> - <?= $row->telp?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="id_akun_debit"  name="id_akun_debit"  class="form-control" required>
                                ...
                                <?php if(count($pengeluaran) > 0 ) { ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php } else { ?>
                                    <option value="" disabled selected>Akun Pengeluaran Tidak Tersedia, Silahkan Tambahkan Terlebih Dahulu</option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="id_akun_kredit" name="id_akun_kredit"  class="form-control" required>
                                ...
                                <?php if(count($hutang) > 0 ) { ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php } else { ?>
                                    <option value="" disabled selected>Akun Hutang Tidak Tersedia, Silahkan Tambahkan Terlebih Dahulu</option>
                                <?php } ?>
                            </select>
                        </div>
