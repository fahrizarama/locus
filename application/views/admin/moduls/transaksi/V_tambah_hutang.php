...
?>
<?php $title = "<i class='far fa-handshake'></i>&nbsp;Transaksi Tambah Hutang"; ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container">
            <form class="form-horizontal" role="form" id="formTransaksi" action="<?= base_url('C_transaksi/add_transaksi_tambah_hutang') ?>" method="POST" enctype="multipart/form-data">
