...
?>
<?php $title = "<i class='fa fa-user-tie'></i>&nbsp;Karyawan"; ?>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($value->foto) { ?>
                                    <img id="myImg" src="<?= base_url('assets/img/' . $value->foto) ?>" width="100">
                                <?php } ?>
                            </td>
                            ...
                            <td>
                                <a href="<?php echo base_url('C_karyawan/kirim_email'); ?>/<?= $value->id_karyawan ?>" type="button" class="btn btn-success btn-xs" style="font-size:20px">
                                    Kirim<i class="material-icons" style="font-size:20px">email</i>
                                </a>
                                <button type="button" class="btn btn-primary btn-xs" onclick="detail_karyawan('<?= $value->id_karyawan ?>')">
                                    <i class="fa fa-edit"> Detail</i>
                                </button>
                                <!-- <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_karyawan ?>')">
...
<script>
    ...
    function delete_produk(id) {
        ...
        if (confirmation) {
            $.ajax({
                url: '<?= base_url('C_karyawan/hapus_karyawan') ?>',
                method: 'POST',
                dataType: 'json',
                data: {
                    id: id
    ...
    function detail_karyawan(id) {
        $.ajax({
            url: '<?php echo base_url('C_karyawan/detail_karyawan'); ?>',
            method: 'POST',
            dataType: 'json',
            data: {
                id: id
