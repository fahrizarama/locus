...
?>
<?php $title = "<i class='fa fa-images'></i>&nbsp;Galeri"; ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="deskripsi_foto" id="input_deskripsi" placeholder="Deskripsi Foto"></textarea>
                                </div>

                                <div class="col-md-12">
                                    <label>Tanggal Foto</label>
                                    <input type="date" class="form-control" name="tanggal_foto" placeholder="Tanggal Foto" required>
                                </div>
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                             ...
                             <td><?= $value->deskripsi_foto ?></td>
                              <td><?= $value->tanggal_foto ?></td>
                            <td>
