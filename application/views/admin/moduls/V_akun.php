...
?>
<?php $title = "<i class='fa fa-sliders-h'></i>&nbsp;Slider"; ?>
...
<div class="row">
    <div class="col-md-12">
        <!-- <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Akun</a>
        </div> -->
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value->admin_view_password ?></td>
                            <td><?= $value->admin_level ?></td>
                            <!-- <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_admin ?>')">
                                <i class="fa fa-edit"> Edit</i>
                            </button>
                            <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_admin ?>')">
