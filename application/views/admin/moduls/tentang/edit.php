        ...
        <form class="form-horizontal" role="form" id="formEditPengalaman" action="<?= base_url('C_tentang/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <label>Visi</label>
                        <textarea class="form-control" name="visi" id="edit_visi_input" placeholder="Deskripsi Tentang"><?= $data->visi ?></textarea>
                    </div>

                    <div class="col-md-12">
                        <label>Misi</label>
                        <textarea class="form-control" name="misi" id="edit_misi_input" placeholder="Deskripsi Tentang"><?= $data->misi ?></textarea>
                    </div>
                </div>
            </div>
