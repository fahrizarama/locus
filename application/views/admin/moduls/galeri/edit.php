            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="deskripsi_foto" id="edit_input_deskripsi" placeholder="Deskripsi Foto"><?= $data->deskripsi_foto ?></textarea>
                    </div>

                    <div class="col-md-12">
                        <label>Tanggal Foto</label>
                        <input type="date" class="form-control" name="tanggal_foto" placeholder="Tanggal Foto" value="<?= $data->tanggal_foto?>" required>
                    </div>             
                </div>
            </div>
