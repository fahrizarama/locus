...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formDetailPelamar" action="<?= base_url('C_recruitment/confirm_pelamar') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_karyawan" value="<?= $pelamar->id_karyawan ?>">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Data Pelamar</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <div>
                    <a href="#pilihJabatan" role="button" class="btn btn-primary btn-sm pull-right" data-toggle="modal">Pilih Jabatan</a>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h3 class="smaller lighter blue no-margin">Pilih Jabatan</h3>
                    </div>
                    <div class="modal-body" >
                        <div class="row">
                            <div class="section">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success btn-sm pull-right" style="margin-right: 5px;">Terima Lamaran</button>
                    </div>
                </div>
            </div>
        </div>
